package com.dizzlepop12.premiumwood.world.gen;
...
public class WorldGenPremiumTrees implements IWorldGenerator {
	
	private final WorldGenerator IRONWOOD = new WorldGenIronwoodTree();

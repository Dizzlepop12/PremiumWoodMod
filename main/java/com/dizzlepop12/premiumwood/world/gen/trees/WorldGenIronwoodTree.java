package com.dizzlepop12.premiumwood.world.gen.trees;
...
public class WorldGenIronwoodTree extends WorldGenAbstractTree 
{
	...
	public boolean generate(World world, Random rand, BlockPos pos) 
	{
		...
		else
		{
			...
			boolean isSoil = state.getBlock().canSustainPlant(state, world, down, EnumFacing.UP, (BlockModSapling)PWBlocks.SAPLINGS);
